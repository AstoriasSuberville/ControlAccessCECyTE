            ...
            <div class="col-3">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button class="nav-link active" id="v-pills-home-tab" data-toggle="pill" data-target="#v-pills-home"
                        type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">Estudiante</button>
                    <button class="nav-link" id="v-pills-profile-tab" data-toggle="pill" data-target="#v-pills-profile"
                        type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">Tutor</button>
                </div>
            </div>
            <div class="col-9">
                    ...
                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                        ...
                        <form action="/api/update-information-student.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="user_barcode"
                                    value="<?php echo stripslashes($student['user_barcode']); ?>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Nombre Completo</label>
                                <input type="text" name="user_name"
                                    value="<?php echo stripslashes($student['user_name']); ?>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Apellido Paterno</label>
                                <input type="text" name="user_last_name_p"
                                    value="<?php echo stripslashes($student['user_last_name_p']); ?>"
                                    class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Apellido Materno</label>
                                <input type="text" name="user_last_name_m"
                                    value="<?php echo stripslashes($student['user_last_name_m']); ?>"
                                    class="form-control">
                            </div>
                            <div class="form-group">
                                ...
                                <select name="especialty_name" class="form-control">
                                    ...
                                    ?>
                                    <option value="<?php echo $espealty['id']; ?>"
                                        <?php if ($espealty['id'] == $student['especialty_id']) echo "selected"; ?>>
                                        <?php echo $espealty['name']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="d-flex justify-content-end">
                                <button type="submit" name="update-information-student"
                    ...
                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                        ...
                        <form action="/api/update-information-tutor.php" method="post">
                            ...
                            <input type="hidden" name="tutor_id"
                                value="<?php echo stripslashes($student['tutor_id']); ?>">
                            <div class="form-group">
                                <label>Nombre</label>
                                <input type="text" name="tutor_name"
                                    value="<?php echo stripslashes($student['tutor_name']); ?>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Apellido Paterno</label>
                                <input type="text" name="tutor_last_name_p"
                                    value="<?php echo stripslashes($student['tutor_last_name_p']); ?>"
                                    class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Apellido Materno</label>
                                <input type="text" name="tutor_last_name_m"
                                    value="<?php echo stripslashes($student['tutor_last_name_m']); ?>"
                                    class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Numero de Telefonico de Casa</label>
                                <input type="number" name="tutor_tel_home"
                                    value="<?php echo stripslashes($student['tutor_tel_home']); ?>"
                                    class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Numero de Telefono Personal</label>
                                <input type="number" name="tutor_tel_personal"
                                    value="<?php echo stripslashes($student['tutor_tel_personal']); ?>"
                                    class="form-control">
                            </div>
                            <div class="d-flex justify-content-end">
                                <button type="submit" name="update-information-student"
